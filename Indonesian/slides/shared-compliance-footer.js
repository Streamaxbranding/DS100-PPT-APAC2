...
(function () {
  ...
  function mountFooter() {
    ...
    footer.setAttribute('aria-label', 'Penafian produk dan kinerja');
    [
      'Fitur produk, spesifikasi, fungsi AI, dukungan kepatuhan, dan kinerja dapat berbeda',
      'berdasarkan konfigurasi, pasar, dan kondisi pengoperasian. Data dan perbandingan hanya sebagai referensi;',
      'hasil aktual dapat berbeda. Silakan hubungi Streamax untuk ketersediaan dan persyaratan setempat.'
