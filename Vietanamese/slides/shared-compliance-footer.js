...
(function () {
  ...
  function mountFooter() {
    ...
    footer.setAttribute('aria-label', 'Tuyên bố miễn trừ về sản phẩm và hiệu suất');
    [
      'Tính năng, thông số kỹ thuật, chức năng AI, hỗ trợ tuân thủ và hiệu suất có thể thay đổi',
      'tùy theo cấu hình, thị trường và điều kiện vận hành. Dữ liệu và so sánh chỉ mang tính tham khảo;',
      'kết quả thực tế có thể khác biệt. Vui lòng liên hệ Streamax để biết khả năng cung cấp và yêu cầu tại địa phương.'
